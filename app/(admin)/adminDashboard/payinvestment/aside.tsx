// app/admin/payinvestment/aside.tsx
"use client";
  ...
  return (
    <div className="bg-black px-1 py-5 md:px-10">
      <div className="flex items-center justify-between">
        <p className="text-xl font-extrabold text-white">Pay Investment Users</p>
        <div></div>
      </div>
      ...
      <div className="py-5">
        <div className="flex items-center py-4">
          ...
          <DrawerDialogDemo component={FilterForm}>
            <Button variant="outline" className="ml-4 bg-green-400">
