    ...
    <div className="container flex items-center justify-center min-h-[90dvh] md:min-h-[70dvh] max-h-[90dvh] md:max-h-[70dvh] p-4">
      <Card className="w-full">
        ...
        <CardContent className="flex flex-col items-center space-y-8">
          <div>
            <LottieAnimation animationData={HappyEmoji} largeScreenSize={600} />
          </div>
          <div className="flex flex-col items-center space-y-4">
            <Link
              href="/dashboard"
              className={`px-8 py-3 text-xl font-semibold ${buttonVariants()} bg-red-700 rounded-lg shadow-md text-center`}
            >
              Go To Dashboard
            </Link>
            <h2 className="text-2xl font-bold text-center">
              Your Payment is awaiting approval by the admin.
            </h2>
            <p className="text-lg text-center">
              It will reflect in your dashboard within 24 hours.
            </p>
          </div>
        </CardContent>
      </Card>
