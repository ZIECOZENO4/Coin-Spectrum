...
-- CreateEnum
CREATE TYPE "InvestmentPlanName" AS ENUM ('BASIC_PLAN', 'SILVER_PLAN', 'GOLDEN_PLAN', 'AMBASSADORSHIP_PLAN', 'PLATINUM_PLAN', 'VIP_PLAN', 'REAL_ESTATE_PLAN', 'MINING_PLAN', 'PERSONAL_LOAN_PACKAGE', 'BUSINESS_LOAN_PACKAGE', 'MORTGAGE_LOAN_PACKAGE');

-- CreateEnum
CREATE TYPE "Wallets" AS ENUM ('BTC', 'DOGE', 'BCH', 'LTC', 'ETH', 'USDT', 'TRX');
...
CREATE TABLE "InvestmentPlan" (
    ...
    "periodicProfit" DOUBLE PRECISION NOT NULL,
...
CREATE TABLE "Investment" (
    ...
    "name" TEXT NOT NULL,
    "email" TEXT NOT NULL,
    "walletPaidInto" "Wallets" NOT NULL,
